...
const seedSuperUserRequests = 'INSERT INTO requests (title,type,description,user_id,status) VALUES (\'My Television\',\'repair\',\'My Television displays black and white and cant dispaly colors\',1,\'pending\'); INSERT INTO requests (title,type,description,user_id,status) VALUES (\'Bad Air Conditioner\',\'repair\',\'The air conditioner makes noise and doesnt cool\',1,\'approved\');';
