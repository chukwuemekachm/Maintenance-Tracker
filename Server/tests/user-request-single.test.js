  ...
  it('should return 200 and requests, when token is valid and requests exists', (done) => {
    chai.request(server)
      ...
      .end((req, res) => {
        ...
        res.should.be.a('object');
        res.body.should.have.property('status').eql('success');
        res.body.should.have.property('message').eql('Request retrieved successfully');
        res.body.should.have.property('code').eql(200);
  ...
  it('should return 404 when no request exist for the user', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        ...
        res.body.should.have.property('status').eql('fail');
        res.body.should.have.property('message').eql('Request does not exist for the user');
        done();
      });
  });

  it('should return 400, when requestId parameter is not valid', (done) => {
    chai.request(server).get('/api/v1/users/requests/hs').end((req, res) => {
